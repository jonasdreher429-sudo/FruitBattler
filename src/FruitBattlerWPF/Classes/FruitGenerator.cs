...
namespace FruitBattlerWPF.Classes
{
    ...
    public static class FruitGenerator
    {
        public static List<Fruit> CreateAllFruits()
        {
            ...
            Fruit pyronana = new Fruit("Pyronana", Type.Feuer, 60, 80, 50, 70, new Move[] { sleepMove, pyroPfeffer, pyroFunke }, null);
            ...
            Fruit aquabeere = new Fruit("Aquabeere", Type.Wasser, 70, 60, 65, 65, new Move[] { sleepMove, aquaWelle, aquaSchnitt }, null);
            ...
            Fruit voltimette = new Fruit("Voltimette", Type.Elektro, 50, 65, 55, 90, new Move[] { sleepMove, voltiSchock, voltiSchnitt }, null);
            ...
            Fruit florapfel = new Fruit("Florapfel", Type.Pflanze, 80, 50, 80, 50, new Move[] { sleepMove, floraWurzel, floraMatsch }, null);
            ...
            Fruit frostube = new Fruit("Frostube", Type.Eis, 65, 70, 60, 65, new Move[] { sleepMove, frostEiszapfen, frostBlase }, null);
            ...
            Fruit terrango = new Fruit("Terrango", Type.Erde, 85, 65, 75, 35, new Move[] { sleepMove, terraBeben, terraGift }, null);
            ...
            Fruit windpfirsich = new Fruit("Windpfirsich", Type.Flug, 55, 70, 50, 85, new Move[] { sleepMove, windOrkan, windSpore }, null);
            ...
            Fruit mystikokos = new Fruit("Mystikokos", Type.Psycho, 65, 75, 55, 65, new Move[] { sleepMove, mystikTrance, mystikFunke }, null);
            ...
            Fruit toxibirne = new Fruit("Toxibirne", Type.Gift, 70, 65, 65, 60, new Move[] { sleepMove, toxiToxin, toxiBiss }, null);
            ...
            Fruit knacknuss = new Fruit("Knacknuss", Type.Gestein, 60, 55, 110, 35, new Move[] { sleepMove, knackFels, knackRamm }, null);
            ...
            Fruit schattenfeige = new Fruit("Schattenfeige", Type.Unlicht, 55, 80, 55, 70, new Move[] { sleepMove, schattenTerror, schattenPsy }, null);
            ...
            Fruit glanzkirsche = new Fruit("Glanzkirsche", Type.Licht, 60, 70, 55, 75, new Move[] { sleepMove, glanzStrahl, glanzGlut }, null);
